...
#> MBG model fitting
#> MBG model fitting: 12.689 sec elapsed
#> Generating model predictions
#>   Parameter posterior samples
#>   Parameter posterior samples: 5.91 sec elapsed
#>   Cell draws
#>   Cell draws: 2.036 sec elapsed
#>   Summarize draws
#>   Summarize draws: 0.845 sec elapsed
#> Generating model predictions: 8.794 sec elapsed
